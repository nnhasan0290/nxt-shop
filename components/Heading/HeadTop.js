...
const HeadTop = () => {
  ...
  return (
    <div className="px-10 border bg-[#081828] text-white py-4 flex items-center justify-between">
      <div className="items-center hidden space-x-2 md:flex basis-1/3">
      ...
      <div className="flex items-center justify-center w-full space-x-3 sm:basis-1/3">
        <p>Hello</p>
        {isAuthenticated ? (
          <>
            <p> {user?.fname}</p>
            <button
              ...
              className="bg-[#0167f3] hover:bg-[#081828] transition duration-300 text-white p-2 rounded-md"
            >
              Log Out
            </button>
          </>
